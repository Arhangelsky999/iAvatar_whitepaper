...
Проблема существующей системы лежит за пределами модели картины миры общепринятого консенсуса, поэтому для того чтобы ее решить нужно расширить горизонты восприятия. Для этого за базис восприятия мы берем Культ Предков https://www.youtube.com/watch?v=LLAUkSirARU
...
FaceID - Методология идентификация лица
